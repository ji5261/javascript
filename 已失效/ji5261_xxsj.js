/**
 * 休闲水晶 app (链接带邀请)  谢谢填写
 * 下载地址: http://xxsj.jmsfx.top/download/fd83bb99aa45b91d?user=39502
 * 
 * cron 0 * * * *  ji5261/ji5261_xxsj.js
 *
 ...
 * ========= 青龙 =========
 * 变量格式: export xxsj_data='userid1 @ userid2'  多个账号用 @分割
 *
...
//////////////////////
let ckStr = process.env.xxsj_data;
let xxsj_dataArr = [];
let msg = "";
let ck = "";
let sign = "";
...
!(async () => {
	let ckArr = await getCks(ckStr, "xxsj_data");
...
/**
 * 签到   get
 * https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=user&sign=e5f6841929074f118a39f5da4a8adbc6&m=skai_tooln_c&dopost=make_sign&userid=39502
 * 
 * 
 * 
 */
async function signin(timeout = 3 * 1000) {
	...
	let url = {
		url: `https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=user&sign=${sign}&m=skai_tooln_c&dopost=make_sign&userid=${ck}`,
		headers: {
...
/**
 * 观看视频   get
 * https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=user&sign=4ca5032b2f0f16e2423880292792e5fa&m=skai_tooln_c&dopost=get_some_power_ad_video&userid=39502
 */
async function ad_video(timeout = 3 * 1000) {
	...
	let url = {
		url: `https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=user&sign=${sign}&m=skai_tooln_c&dopost=get_some_power_ad_video&userid=${ck}`,
		headers: {
			"Content-Type": "application/x-www-form-urlencoded",
			Host: "nn.jmsfx.top",
		},
...
/**
 * 京喜红包   get
 * https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=user&sign=13a6d7f8418c39085c261a91e9da665a&m=skai_tooln_c&dopost=get_some_gold_ad_video_full&userid=39502
 */
async function gold_ad_video(timeout = 3 * 1000) {
	...
	let url = {
		url: `https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=user&sign=${sign}&m=skai_tooln_c&dopost=get_some_gold_ad_video_full&userid=${ck}`,
		headers: {
			"Content-Type": "application/x-www-form-urlencoded",
			Host: "nn.jmsfx.top",
		},
...
/**
 * 升级   get
 * https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=user&sign=d1a53fca503869437cd14a2f0e9ab794&m=skai_tooln_c&dopost=update_grade&userid=39502
 */
async function Upgrade(timeout = 3 * 1000) {
	...
	let url = {
		url: `https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=user&sign=${sign}&m=skai_tooln_c&dopost=update_grade&userid=${ck}`,
		headers: {
			"Content-Type": "application/x-www-form-urlencoded",
			Host: "nn.jmsfx.top",
		},
...
/**
 * 一键收矿石   get
 * https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=friend&sign=5d1015991229a24dbb4f513a35db571b&m=skai_tooln_c&dopost=all_take_up&userid=39502
 */
async function collection(timeout = 3 * 1000) {
	...
	let url = {
		url: `https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=friend&sign=${sign}&m=skai_tooln_c&dopost=all_take_up&userid=${ck}`,
		headers: {
			"Content-Type": "application/x-www-form-urlencoded",
			Host: "nn.jmsfx.top",
		},
...
/**
 * 红包雨   get
 * https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=index&sign=f85cf8026a9b813635995a143f9d3039&m=skai_tooln_c&dopost=rain_open_redbag&userid=39502&time=11
 */
async function rain_open_redbag(timeout = 3 * 1000) {
	...
	let url = {
		url: `https://nn.jmsfx.top/app/index.php?i=2&t=0&v=1.0&from=wxapp&c=entry&a=wxapp&do=index&sign=${sign}&m=skai_tooln_c&dopost=rain_open_redbag&userid=${ck}&time=${time}`,
		headers: {
			"Content-Type": "application/x-www-form-urlencoded",
			Host: "nn.jmsfx.top",
		},
